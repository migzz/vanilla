    ...
    (function () {
        ...
        // this module name like vanilla.app.BranchVariable
            module_name      = 'TimeSitting',

        // display name
            model_display_name = 'Time Sitting',

        // rest name
            model_name       = 'time_sitting',

        // class name
            model_class       = 'time-sitting',
            ...
            return vanilla.app.module(module_name + '.View', function ( View, App, Backbone, Marionette, $, _ ) {
                ...
                View.CreateItemView = Marionette.ItemView.extend({
                    ...
                    events : {
                        ...
                        'change #sun, #mon, #tue, #wed, #thu, #fri, #sat' : 'checkboxTick'
                    },

                    //
                    checkboxTick : function (event) {

                        //console.log(event.currentTarget);
                        var $el = $(event.currentTarget),
                            $elHidden = $(event.currentTarget.nextElementSibling);
                ...
                View.ItemDetailView = Marionette.ItemView.extend({
                    ...
                    onDomRefresh: function(){
                        ...
                        //
                        $('#sun, #mon, #tue, #wed, #thu, #fri, #sat').each(function () {
                            var $this = $(this),
                                $thisHidden = $(this.nextElementSibling);
