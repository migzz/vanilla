            ...
            return vanilla.app.module(module_name + '.View', function ( View, App, Backbone, Marionette, $, _ ) {
                ...
                View.CreateItemView = Marionette.ItemView.extend({
                    ...
                    onDomRefresh: function(){
                        ...
                        //
                        $(this.el).find('select').trigger('input');
                    }
                ...
                View.ItemDetailView = Marionette.ItemView.extend({
                    ...
                    onDomRefresh: function(){
                        ...
                        setTimeout( function () {
                            ...
                            var dataType = $($this.el).find('#data-type'),
                                printerType =  $($this.el).find('#printer-type');

                            // set selected value
                            dataType.find('select').val(model.get('data_type')).trigger('change');
                            printerType.find('select').val(model.get('printer_type')).trigger('change');
