    ...
    (function () {
        ...
        // this module name like vanilla.app.BranchVariable
            module_name      = 'AssociateContact',

        // display name
            model_display_name = 'Associate Contact',

        // rest name
            model_name       = 'associate_contact',

        // class name
            model_class       = 'associate-contact',
    ...
    define([
        ...
        return vanilla.app.module(module_name + '.View', function ( View, App, Backbone, Marionette, $, _ ) {
            ...
            /* layout collection for setting like for branch, area, etc */
