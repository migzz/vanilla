...
/** Menu View
    ...
    define([
        ...
        vanilla.path.requireText + '/app/control_panel/templates/setting/menu/details.html',
        vanilla.path.requireText + '/app/control_panel/templates/setting/menu/create.html',
        vanilla.path.requireText + '/app/control_panel/templates/setting/menu/edit.html'
    ], function (
        listTemplate,
        itemTemplate,
        itemDetailsTemplate,
        ...
        listTemplate = listTemplate
            .replace(/{model-class}/, 'menu')
            .replace(/{display-title}/, 'Menus')
            .replace(/{model}/, 'Menu');

        //
        return vanilla.app.module(modelTag + '.View', function ( View, App, Backbone, Marionette, $, _ ) {

            var $this = vanilla.app.Menu;
