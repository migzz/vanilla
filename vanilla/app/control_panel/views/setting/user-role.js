            ...
            return vanilla.app.module(module_name + '.View', function ( View, App, Backbone, Marionette, $, _ ) {
                ...
                View.CreateItemView = Marionette.ItemView.extend({
                    ...
                    onDomRefresh: function(){
                        ...
                        // user credential select
                        vanilla.app.UserCredential.fetchOptions();

                        vanilla.app.Role.fetchOptions();
                    }
                ...
                View.ItemDetailView = Marionette.ItemView.extend({
                    ...
                    onRender: function(){
                        ...
                        setTimeout( function () {
                            ...
                            var role = $($this.el).find('#role-id-container'),
                                userCredential =  $($this.el).find('#user-credential-id-container');
                            ...
                            // set selected value
                            role.find('select').val(model.get('r_role_name')).trigger('change');
                            userCredential.find('select').val(model.get('uc_username')).trigger('change');
