...
(function () {
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( MenuGroup, App, Backbone, Marionette, $, _ ) {
            ...
            $this.renderCollection = function (region) {
                $this.renderMenu($this.collection, region || layout_container);
            };
            ...
            $this.renderDetailItem = function (model, region) {
                ...
                //$('#controller-dashboard-content').css({"display":"block"}).css({"display":"initial"});
            ...
            /* render collection */
            $this.renderMenu = function (collection, region) {
                ...
                //
                $this.$carousel = Hammr.carousel('.menu.hammer');
