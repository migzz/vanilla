...
(function () {
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'OperatingTime',

    // rest name
        model_name       = 'operating_time',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( OperatingTime, App, Backbone, Marionette, $, _ ) {
