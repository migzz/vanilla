...
(function () {
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'HappyHourTiming',

    // rest name
        model_name       = 'happy_hour_timing',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( HappyHourTiming, App, Backbone, Marionette, $, _ ) {
