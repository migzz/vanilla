...
(function () {
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'BranchVariable',
    
    // rest name
        model_name       = 'branch_variable',
       
    // rest id
        model_key_id     = model_name + '_id',

    // rest display name
        model_key_name   = 'variable_name';


    define([model_name + '_view', model_name + '_model'], function (View, Model) {

        //
        return vanilla.app.module(module_name, function ( BranchVariable, App, Backbone, Marionette, $, _ ) {
