...
(function () {
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'ItemModifier',

    // rest name
        model_name       = 'item_modifier',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( ItemModifier, App, Backbone, Marionette, $, _ ) {
