...
(function () {
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'SpecialTurnTime',

    // rest name
        model_name       = 'special_turn_time',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( SpecialTurnTime, App, Backbone, Marionette, $, _ ) {
