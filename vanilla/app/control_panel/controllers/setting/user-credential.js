...
(function () {
    ...
    var layout_container = 'region_setting_collection',
        ...
        user_credential_container = 'region_user_credential_id',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( UserCredential, App, Backbone, Marionette, $, _ ) {
            ...
            $this.fetchOptions = function () {
                ...
                if ($this.collection == 0) {
                    ...
                    collection.on('sync', function (data) {
                        ...
                        $this.renderSelect($this.collection, user_credential_container);
            ...
            /* render collection */
            $this.renderSelect = function (collection, region) {

                // check if collection is not empty, if empty fetch collection
                //collection = $this.collection;

                // instantiate view
                var select = new View.SelectView( {
                    collection : collection
                });

                // render to region
                App.renderRegion( region, select );
