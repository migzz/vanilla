...
/* Special Operation Date Controller
 */
(function () {
    /* local setting */
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'SpecialOperationDate',

    // rest name
        model_name       = 'special_operation_date',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( SpecialOperationDate, App, Backbone, Marionette, $, _ ) {
