...
(function () {
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( Role, App, Backbone, Marionette, $, _ ) {
            ...
            $this.createItem = function (model, view) {
                ...
                model.on('sync', function () {
                    ...
                    vanilla.app.Module.moduleAccessCreate(model);
                })
            ...
            //
            $this.renderSelect = function (region) {

                setTimeout(function () {
                    vanilla.app.UI.renderSelect($this, region);
                }, 0)
            };
