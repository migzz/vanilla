...
(function () {
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'ItemHappyHour',

    // rest name
        model_name       = 'item_happy_hour',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( ItemHappyHour, App, Backbone, Marionette, $, _ ) {
