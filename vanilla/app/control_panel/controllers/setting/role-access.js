...
(function () {
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( RoleAccess, App, Backbone, Marionette, $, _ ) {
            ...
            $this.renderCreateItem = function (region) {
                ...
                // render to region
                App.renderRegion(region || 'region_role_access_details', createItemView);
            ...
            $this.renderSetting = function (collection, region) {
                ...
                //
                $this.$carousel = Hammr.carousel('.role-access-container > div > .hammer');
