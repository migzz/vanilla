...
(function () {
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'ItemTimeSitting',

    // rest name
        model_name       = 'item_time_sitting',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( ItemTimeSitting, App, Backbone, Marionette, $, _ ) {
