...
(function () {
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'LocationVariable',

    // rest name
        model_name       = 'location_variable',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( LocationVariable, App, Backbone, Marionette, $, _ ) {
