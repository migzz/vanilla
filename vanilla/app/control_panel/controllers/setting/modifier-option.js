...
(function () {
    ...
    // this module name like vanilla.app.BranchVariable
        module_name      = 'ModifierOption',

    // rest name
        model_name       = 'modifier_option',
    ...
    define([model_name + '_view', model_name + '_model'], function (View, Model) {
        ...
        //
        return vanilla.app.module(module_name, function ( ModifierOption, App, Backbone, Marionette, $, _ ) {
